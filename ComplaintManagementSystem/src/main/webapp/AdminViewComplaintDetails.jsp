    ...
    <div class="container mt-5 mb-5">
        <div class="card">
            <div class="card-header">
                <h3><b>View Complaint Details </b></h3>
            </div>
            <div class="card-body">
                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <c:forEach var="complaint" items="${complaintData}" varStatus="status">
                                            <tr>
                                                ...
                                                <td>${complaint.userid.id}</td>
                                                     <form action="allocate-department" method="post">
                                                                            ...
                                                                            <td>
                                                                            <div style="width:110px;">
                                                                                       <select class="form-select" name="departmentsId" id="departmentsId">
                                                                                           <c:forEach var="department" items="${departments}">
                                                                                              <option value="${department.departmentsId}">${department.departmentsType}</option>
                                                                                           </c:forEach>
                                                                                       </select>
                                                                            </div>
