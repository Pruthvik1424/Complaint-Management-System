...
<head>
    ...
    <style>
        ...
        .navbar-custom {
            background: linear-gradient(45deg,#fd7e14,#fff107, #fd7e14); /* Example gradient */
        }
...
<nav class="navbar navbar-custom shadow p-3 ">
    <div class="container-fluid">
        <a class="navbar-brand " href="#">
            <img src="https://x-workz.in/static/media/Logo.cf195593dc1b3f921369.png" style="color:dark" alt="xworkz" width="140" height="70">
        </a>
