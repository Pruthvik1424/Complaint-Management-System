  ...
  <div class="container mt-5 w-100 mb-5 d-flex justify-content-center">
        <div class="card p-4">
            <div class="card-body">
                ...
                <form action="add-departments" method="POST">
                    <h3><b>Add Departments</b></h3>

                                <strong style="color:blue">${departrmentssucccessmsg}</strong>
                                <strong style="color:red">${departmentserrormsg}</strong>

                    <div class="mb-3">
                      <label for="cidepartmentstype" class="form-label"><strong>Department Type:</strong></label>
                      <input type="text" class="form-control" id="cidepartmentstype" name="departmentsType" >
                    </div>

                    <div class="mb-3">
                     <label for="departmentsaddress" class="form-label"><strong>Address :</strong></label>
                      <input type="text" class="form-control" id="departmentsaddress" name="departmentsAddress" >
                     </div>

                      <div class="mb-3">
                      <label for="departmentscity" class="form-label"><strong>City :</strong></label>
                      <input type="text" class="form-control" id="departmentscity" name="departmentsCity" >
                      </div>

                    <div>
                        <input type="submit" id="submit" value="Add Department">
                    </div>
                </form>
            </div>
        </div>
